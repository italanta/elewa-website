...
export class HomePageComponent {
  contentData: ContentText[] = [
    ...
    },
    {
      ...
      descriptions: ['People are the secret to successful education programs. Through in-depth research, we work with your organization at different levels, to understand "elewa" how people live and learn', 'Based on decades of research, this understanding allows us to co-create strong learning networks within your organization, networks can be reused every time a training need arises; at a fraction of the cost of the current solution.'],
    },
