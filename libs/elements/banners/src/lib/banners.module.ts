...
@NgModule({
  ...
  declarations: [ElewaImageAndTextBannerComponent, ElewaImageAndDetailsBannerComponent,],
  exports: [ ElewaImageAndTextBannerComponent, ElewaImageAndDetailsBannerComponent, ],
})
